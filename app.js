Em.I18n.translations = {
  ...
  'app.name.subtitle.experimental':'测试',
  ...
  'app.redirectIssuePopup.body': '对于单点登录，请确保网关和服务器位于同一主机或子域中。' +
    '<br/>或者以本地用户身份使用本地登录页面登录。<br />' +
    '<a href="{0}" target="_blank">{0}</a>',

  'app.loadingPlaceholder': '加载中...',
  'app.versionMismatchAlert.title': '服务器 / Web客户端版本不匹配',
  'app.versionMismatchAlert.body': '服务器与Web客户端版本不匹配：<br> ' +
    '<br>服务器：<strong>{0}</strong>' +
    '<br>Web客户端：<strong>{1}</strong><br>' +
    '<br>这通常发生在升级之后，因为浏览器中缓存了Web客户端代码。' +
    '<br>执行硬浏览器缓存刷新，请按 \'Ctrl+Shift+R\' (Mac OS 请按 \'Cmd+Shift+R\')，看这条消息是否消失。' +
    '<br>如果您依然看到此消息，请完全清除浏览器缓存并再次点击此URL。' +
    '<br>您必须解决此错误才能继续。',
  'app.signout':'退出',
  'app.settings':'设置',
  ...
  'app.settings.notshowBgOperationsPopup': '开始操作时不显示“后台操作”对话框',
  'app.settings.notShowBgOperations': '启动后台操作时，不再显示此对话框',
  ...
  'app.settings.admin.all.privileges': '该用户是管理员，拥有所有权限。',
  ...
  'common.package': '包',
  'common.proceed': '继续',
  'common.proceedAnyway': '仍要继续',
  'common.exitAnyway': '仍要退出',
  'common.process': '处理',
  'common.property': '属性',
  'common.installed': '已安装',
  'common.persist.error' : '在服务器上保持Web客户端状态时出错。服务器返回以下错误消息：',
  'common.update.error' : '从服务器检索Web客户端状态时出错',
  'common.tags': '标签',
  'common.important': '重要',
  ...
  'common.timeout.warning.popup.body.before': '由于未活动时间已达',
  'common.timeout.warning.popup.body.after': ' 秒，您将自动登出',
  'common.timeout.warning.popup.primary': '保持登录状态',
  'common.timeout.warning.popup.secondary': '立即退出',
  'common.openNewWindow': '在新窗口打开',
  'common.fullLogPopup.clickToCopy': '点击以复制',
  'common.nothingToDelete': '没有可删除',
  'common.exclude': '排除',
  'common.include': '包括',
  ...
  'common.extension': '延期',
  'common.logs': '日志',
  'common.warn.message': '<div class="警告">{0}</div>',
  'common.link': '链接',
  ...
  'requestInfo.installKerbeorosComponents':'安装安全认证组件',
  'requestInfo.installServices':'安装服务',
  'requestInfo.kerberosService': '安装安全认证服务',
  ...
  'hostPopup.noServicesToShow':'没有服务可以显示',
  'hostPopup.noHostsToShow':'没有主机可以显示',
  'hostPopup.noTasksToShow':'没有任务可以显示',
  'hostPopup.status.category.all':'所有 ({0})',
  'hostPopup.status.category.pending':'阻塞 ({0})',
  ...
  'hostPopup.bgop.abortRequest.modal.header': '发送中止请求',
  'hostPopup.bgop.abortRequest.modal.body': '中止 <strong>{0}</strong> 的请求已经发送到服务器。注意：在应用中止请求之前，某些已在运行的任务可能有时间完成或失败。',
  'hostPopup.bgop.sourceRequestSchedule.running': '可以中止此批处理请求的未来操作',
  'hostPopup.bgop.sourceRequestSchedule.aborted': '此批处理请求的未来操作已中止',
  'hostPopup.bgop.abort.rollingRestart': '中止滚动重启',
  'hostPopup.warning.alertsTimeOut': '维护模式已经打开 {0}。{1} 的警报可能需要几分钟时间.',
  'hostPopup.reccomendation.beforeDecommission': '{0} 退出任务时需要维护模式。',
  'hostPopup.setRackId.success': '将机架ID更新为 \"{0}\"。它可能需要一些时间才能刷新。',
  'hostPopup.setRackId.error': '更新机架ID失败',
  'hostPopup.setRackId.invalid': '应该以正斜杠开头，它可能包括字母数字字符，点，短划线和正斜杠。',
  'hostPopup.RackId': '架',
  'hostPopup.recommendation.beforeDecommission': '{0} 开始任务时需要维护模式。',

  'question.sure':'确定？',

  'popup.highlight':'点击高亮显示',
  'popup.confirmation.commonHeader':'确认',
  'popup.confirmation.refreshYarnQueues.body':'更改容量调度程序配置后，强烈推荐 <strong>更新 Yarn Queues</strong> 。 您想继续吗？',
  'popup.warning.refreshYarnQueues.body': '<div class="alert alert-warning"><strong>Warning: </strong>队列配置更改可能已影响Hive LLAP使用的队列。 可能需要Hive LLAP重新配置或重新启动。</div>',
  'popup.confirmation.refreshYarnQueues.buttonText':'更新 Yarn Queues',
  'popup.confirmation.hsiRestart.body':'在更改Hive LLAP大小调整配置后，强烈推荐 <strong>Restart HiveServer2 Interactive</strong> 。 您想继续吗？',
  ...
  'popup.clusterCheck.Upgrade.fail.alert': '在继续之前，你 <strong>必须</strong> 满足这些要求。',
  'popup.clusterCheck.Upgrade.bypassed-failures.title': '可以绕过的错误',
  'popup.clusterCheck.Upgrade.bypassed-failures.alert': '由于stack.upgrade.bypass.prechecks设置为true，因此允许绕过错误。 强烈建议调查这些失败。',
  'popup.clusterCheck.Upgrade.warning.title': '警告',
  'popup.clusterCheck.Upgrade.warning.alert': '不需要改正警告，但是 <strong>推荐</strong>这么做。',
  ...
  'popup.dependent.configs.dependencies.config.singular': '配置更改 {0} ',
  'popup.dependent.configs.dependencies.config.plural': '配置更改 {0} ',
  'popup.dependent.configs.dependencies.service.singular': '服务 {0}',
  'popup.dependent.configs.dependencies.service.plural': '服务 {0} ',

  'popup.dependent.configs.dependencies.for.groups': '您正在更改默认组，请选择要从其他服务保存相关配置的配置组',

  'popup.jdkValidation.header': '不支持的 JDK',
  'popup.jdkValidation.body': '{0} 堆栈需要JDK {1} ，但配置为了JDK {2}。 这可能会导致错误或运行群集时出现问题。',
  ...
  'login.error.bad.connection':'无法连接到服务器。 确认服务器正在运行，您可以从此计算机访问服务器。',
  ...
  'users.userName.validationFail': '建议只使用小写字母和数字; 必须以一个字母开头',
  ...
  'services.hive.description':'数据仓库系统，用于临时查询和分析大型数据集以及表和存储管理服务',
  ...
  'services.storm.configs.range-plugin-enable.dialog.title': '启用 Ranger for STORM',
  'services.storm.configs.range-plugin-enable.dialog.message': '为STORM启用Ranger插件仅对安全群集有效。',


  'services.alerts.head':' {0} 个严重警报通知。',
  ...
  'installer.controls.checkConnection.popover':'此操作将检查服务器 {0} 主机和端口的可访问性',
  ...
  'installer.controls.slaveComponentChangeGroupName.error':'组名称已存在',

  'installer.step0.header':'开始',
  'installer.step0.body.header':'开始',
  'installer.step0.body':'该向导将引导您完成群集安装过程。 首先，从命名新集群开始。',
  'installer.step0.clusterName':'给集群命名',
  'installer.step0.clusterName.tooltip.title':'集群名称',
  'installer.step0.clusterName.tooltip.content':'出入一个独一无二的集群名称',
  ...
  'installer.step1.body':'选择群集的软件版本和交付方法。 使用公共存储库需要网络连接。 使用本地存储库要求您已在网络中可用的存储库中配置软件。',
  ...
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg': '无法确认对公共存储库的访问，这意味着您可能无法访问网络，并且无法使用公共存储库选项来安装软件。 你的选择：',
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg1': '配置主机以访问网络。',
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg2': '如果您使用的是网络代理，请参阅平台文档，了解如何配置平台以使用网络代理。',
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg3': '使用“本地存储库”选项。',
  'installer.step1.selectUseRepoOptions.public.networkLost.popup.msg4': '如果您没有网络访问权限并选择此选项，则将无法通过存储库基本URL验证。',
  ...
  'installer.step1.addVersion.stackChanged.popup.body': '堆栈从 {0} 改到了 {1}.',
  'installer.step1.useLocalRepo.enterUrl': '版本定义文件 URL',
  ...
  'installer.step1.useLocalRepo.infoForm.alert.warning': '某些存储库未通过验证。 如果您确定网址正确，请更改基本网址或跳过验证',
  'installer.step1.advancedRepo.title':'高级存储库选项',
  'installer.step1.advancedRepo.message':'自定义存储库基本URL以下载Stack软件包。 如果主机无法访问Internet，则必须创建可由所有主机访问的堆栈存储库的本地镜像，并在此处使用这些基本URL。',
  'installer.step1.advancedRepo.importantMassage':'<b>Important:</b> 使用本地镜像存储库时，只需为要为堆栈安装的操作系统提供基本URL。 取消选中所有其他存储库。',
  ...
  'installer.step1.advancedRepo.localRepo.column.baseUrl':'基本 URL',
  ...
  'installer.step1.advancedRepo.skipValidation.tooltip':'<b>Warning:</b> 这仅适用于高级用户。 如果要跳过存储库基本URL的验证，请使用此选项。',
  'installer.step1.advancedRepo.useRedhatSatellite.tooltip':'禁用分布式存储库并改为使用RedHat Satellite / Spacewalk通道',
  ...
  'installer.step1.advancedRepo.useRedhatSatellite.warning': '通过为软件仓库选择 <b>“Use RedHat Satellite/Spacewalk”</b>, ' +
    '您负责在Satellite / Spacewalk中配置存储库通道，并确认所选<b>stack version</b>的存储库在群集中的主机上可用。' +
    '有关更多信息，请参阅平台文档。',
  'installer.step1.addOs.disabled.tooltip':'已添加所有操作系统',
  'installer.step1.attentionNeeded':'<b>Attention:</b> 在继续之前，至少需要一个操作系统的存储库基本URL。 请确保它们的协议格式正确。',
  'installer.step1.invalidURLAttention': '<b>Attention:</b> P在继续之前，请确保所有存储库URL都有效。',
  'installer.step1.checkAtLeastOneAttention': '<b>Attention:</b> 请至少检查一个存储库。',
  'installer.step1.retryRepoUrls': '点击 <b>这里</b> 重试.',

  'installer.step2.header':'安装选项',
  'installer.step2.body':'输入要包含在群集中的主机列表，并提供SSH密钥。',
  ...
  'installer.step2.hostPattern.tooltip.content':'您可以使用模式表达式指定多个目标主机。 例如，要通过host10.domain指定host01.domain，请在目标主机文本区域中输入host [01-10] .domain。',
  'installer.step2.hostName.error.required':'您必须至少指定一个主机名',
  'installer.step2.hostName.error.already_installed':'所有这些主机已经是群集的一部分',
  'installer.step2.hostName.error.notRequired':'如果不使用SSH自动配置主机，则将忽略主机名',
  ...
  'installer.step2.manualInstall.info':'通过不使用SSH连接到目标主机，您必须手动安装和' +
    ' 在每台主机上启动Ambari Agent，以便向导执行必要的配置' +
    ' 软件安装。',
  'installer.step2.advancedOption':'高级选项',
  'installer.step2.repoConf':'软件存储库配置文件路径',
  'installer.step2.advancedOptions.header':'高级选项',
  'installer.step2.localRepo.label_use':'使用 a',
  'installer.step2.localRepo.label_instead':'而不是从互联网上下载软件包',
  'installer.step2.localRepo.error.required':'本地存储库文件路径是必需的',
  'installer.step2.localRepo.tooltip.title':'本地软件库',
  'installer.step2.localRepo.tooltip.content': '群集安装需要访问Internet才能获取软件 ' +
    '来自远程存储库。 在某些情况下，没有足够的带宽，您想要阻止下载' +
    '来自远程存储库的包一遍又一遍。 其他时候，无法访问互联网' +
    '群集中的主机。 在这些情况下，您必须设置机器可以存储的版本' +
    '本地访问，这称为 <b>本地软件库</b>',
  'installer.step2.javaHome.label' : ' 64-bit JDK 路径',
  'installer.step2.javaHome.tooltip.title' : 'JAVA_HOME',
  'installer.step2.javaHome.tooltip.content' : '64-bit JAVA_HOME 路径. /usr/jdk/jdk1.6.0_31 是平台的默认路径。您可以将其覆盖到包含JDK的特定路径。 <br/> 注意：路径必须对群集中的<b>所有</b>主机有效。',
  'installer.step2.javaHome.tooltip.placeholder' : '/usr/jdk/jdk1.6.0_31',
  'installer.step2.automaticInstall.tooltip.title':'自动注册',
  'installer.step2.automaticInstall.tooltip.content':'平台将在群集安装之前在每台主机上自动安装和注册代理。',
  ...
  'installer.step2.useSsh.tooltip.content':'<b>SSH私钥文件</b> 用于连接到群集中的目标主机以安装代理。',
  ...
  'installer.step2.manualInstall.tooltip.content':'在每台主机上手动注册代理无需SSH，应在继续安装集群之前执行。',
  'installer.step2.manualInstall.tooltip.content_no_ssh':'应在继续群集安装之前，在每台主机上手动注册代理。',
  'installer.step2.manualInstall.popup.header':'在你继续之前',
  'installer.step2.manualInstall.popup.body':'在继续之前，必须在要管理的每个主机上安装代理。',
  'installer.step2.warning.popup.body':'<p>以下主机名不是有效的FQDN：</p><p> {0} </p><p>这可能会在安装过程中出现问题 你想继续吗？</p>',
  ...
  'installer.step2.sshUser.toolTip':'用于通过SSH在目标主机上安装代理的用户帐户。 必须在所有目标主机上为此用户设置无密码SSH和sudo访问权限',
  'installer.step2.sshUser.placeholder':'输入用户名',
  'installer.step2.sshUser.required':'用户名是必需的',
  'installer.step2.sshPort':'SSH端口号',
  'installer.step2.sshPort.toolTip':'SSH端口名称',
  'installer.step2.sshPort.required':'SSH端口号是必需的。',
  'installer.step2.agentUser':'代理用户帐户',
  'installer.step2.agentUser.toolTip':'用于在目标主机上运行代理守护程序的用户帐户。 必须在所有目标主机上为此用户设置无密码sudo访问权限',
  'installer.step2.bootStrap.error':'在主机上设置代理时遇到错误。',
  'installer.step2.bootStrap.inProgress':'请等待主机上安装代理。 这可能需要几分钟，具体取决于主机数量。',
  'installer.step2.bootStrap.header':'设置代理',
